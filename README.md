...
Шаблон содержет решение **Tanais.ExampleMdl**, в котором реализовано несколько примеров использования структурированного логирования в виде готового кода:
...
***Перед использованием шаблона необходимо удалить Tanais.ExampleMdl.***
